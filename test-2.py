...
# 设置目标网址
url = ["https://imagingmall.com/jumpshop/EventPhoto?EventId=00025", 
       'https://imagingmall.com/jumpshop/EventPhoto?EventId=00025&page=2&SearchTab=0&IsResearch=True&FaceSortFlag=False#pagetop']  # 替换成你要抓取的实际网站URL
...
def main():
    ...
    for i in range(len(url)):
        ...
        for img_tag in img_tags:
            ...
            img_number += 1
        image_data_final += image_data[1:-1]

    
    # 创建 Word 文件
    create_word_document(image_data_final, 'image_data_2.docx')
